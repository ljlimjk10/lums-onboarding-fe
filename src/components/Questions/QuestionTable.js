...
const BASE_URL = "http://13.215.50.140:3002";
...
function QuestionTable() {
  ...
  const deleteData = async () => {
    ...
    setShowPopUp(false);
    try {
      await Promise.all(selectedQuestions.map((questionId) => axios.delete(`http://13.215.50.140:3002/api/faq/delete/${questionId}`,{headers:authHeader()})));
      refreshData();
